...
public class Facultad {
    ...
    private int ultimaPos=0;//variable donde se guarda la ultima posicion donde se guardo un alumno.
    ...
    public Integer buscarAlumno(String nombre){ //Metodo que busca por un nombre y devuelve la posicion del alumno.
    	Integer retorno=null; //se usa un Integer para poder inicializar en nulo y devolver nulo en caso de que no se encuentre el nombre.
    ...
    public void borrarAlumno(Long id){//Borra un alumno del arreglo
        ...
        for (int i=0; i< ultimaPos;i++){ //recorre el arreglo hasta la ultima posicion no nula.
        ...
        if (encontrado!=null) { //si encontrado es distinto de null quiere decir que se encontro un alumno
            ...
            ultimaPos--;//se actualiza la ultima posicion donde hay un alumno.
